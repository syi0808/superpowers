...
description: Use when writing any user-facing text, blog posts, marketing copy, documentation, emails, or articles. Also use when the user mentions "sounds like AI," "too robotic," "make it human," "natural writing," or asks to avoid AI-sounding language.
---
